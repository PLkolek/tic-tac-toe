...
export type MutationResolverFunction<Args = any> = IFieldResolver<void, Context, MutationInput<Args>>
...
export type Resolver<Parent> =
    { [key: string]: ResolverFunction<Parent> }

export type MutationResolver =
    { [key: string]: MutationResolverFunction }

export type SubscriptionResolver =
    { [key: string]: SubscriptionResolverDefinition }
